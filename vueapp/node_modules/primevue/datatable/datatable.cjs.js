...
const _hoisted_2 = /*#__PURE__*/vue.createVNode("span", { class: "pi pi-filter-icon pi-filter" }, null, -1);
const _hoisted_3 = /*#__PURE__*/vue.createVNode("span", { class: "pi pi-filter-slash" }, null, -1);
const _hoisted_4 = {
  key: 0,
  class: "p-column-filter-row-items"
};
const _hoisted_5 = /*#__PURE__*/vue.createVNode("li", { class: "p-column-filter-separator" }, null, -1);
const _hoisted_6 = {
  key: 0,
  ...
  return (vue.openBlock(), vue.createBlock("th", {
    ...
    vue.createVNode("div", _hoisted_1$1, [
      ...
      ($options.columnProp('header'))
        ? (vue.openBlock(), vue.createBlock("span", _hoisted_2$1, vue.toDisplayString($options.columnProp('header')), 1))
        : vue.createCommentVNode("", true),
      ...
      ($options.isMultiSorted())
        ? (vue.openBlock(), vue.createBlock("span", _hoisted_3$1, vue.toDisplayString($options.getMultiSortMetaIndex() + 1), 1))
        : vue.createCommentVNode("", true),
  ...
  return (vue.openBlock(), vue.createBlock("thead", _hoisted_1$2, [
    (!$props.columnGroup)
      ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
          vue.createVNode("tr", _hoisted_2$2, [
...
const _hoisted_3$3 = /*#__PURE__*/vue.createVNode("span", { class: "p-row-editor-save-icon pi pi-fw pi-check" }, null, -1);
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("td", {
    ...
    ($props.responsiveLayout === 'stack')
      ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$4, vue.toDisplayString($options.columnProp('header')), 1))
      : vue.createCommentVNode("", true),
                    ...
                    return (vue.openBlock(), vue.createBlock(vue.Fragment, {
                      ...
                      ($options.shouldRenderBodyCell($props.value, col, index))
                        ? (vue.openBlock(), vue.createBlock(_component_DTBodyCell, {
                          ...
                          }, null, 8, ["rowData", "column", "index", "selected", "rowTogglerIcon", "frozenRow", "rowspan", "editMode", "editing", "responsiveLayout"]))
                        : vue.createCommentVNode("", true)
                    ], 64))
                  }), 128))
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ($options.hasFooter)
    ? (vue.openBlock(), vue.createBlock("tfoot", _hoisted_1$6, [
        (!$props.columnGroup)
          ? (vue.openBlock(), vue.createBlock("tr", _hoisted_2$5, [
              (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($props.columns, (col, i) => {
                return (vue.openBlock(), vue.createBlock(_component_DTFooterCell, {
                  key: $options.columnProp(col,'columnKey')||$options.columnProp(col,'field')||i,
                  column: col
                }, null, 8, ["column"]))
              }), 128))
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    vue.createVNode("div", {
      ...
      vue.createVNode("table", _hoisted_3$4, [
        ...
        vue.createVNode(_component_DTTableBody, {
          ...
          onRowRightclick: _cache[27] || (_cache[27] = $event => ($options.onRowRightClick($event))),
          onRowTouchend: $options.onRowTouchEnd,
          onRowKeydown: $options.onRowKeyDown,
          onRowMousedown: $options.onRowMouseDown,
          onRowDragstart: _cache[28] || (_cache[28] = $event => ($options.onRowDragStart($event))),
          onRowDragover: _cache[29] || (_cache[29] = $event => ($options.onRowDragOver($event))),
          onRowDragleave: _cache[30] || (_cache[30] = $event => ($options.onRowDragLeave($event))),
          onRowDragend: _cache[31] || (_cache[31] = $event => ($options.onRowDragEnd($event))),
          onRowDrop: _cache[32] || (_cache[32] = $event => ($options.onRowDrop($event))),
          onRowToggle: _cache[33] || (_cache[33] = $event => ($options.toggleRow($event))),
          onRadioChange: _cache[34] || (_cache[34] = $event => ($options.toggleRowWithRadio($event))),
          onCheckboxChange: _cache[35] || (_cache[35] = $event => ($options.toggleRowWithCheckbox($event))),
          onCellEditInit: _cache[36] || (_cache[36] = $event => ($options.onCellEditInit($event))),
          onCellEditComplete: _cache[37] || (_cache[37] = $event => ($options.onCellEditComplete($event))),
          onCellEditCancel: _cache[38] || (_cache[38] = $event => ($options.onCellEditCancel($event))),
          onRowEditInit: _cache[39] || (_cache[39] = $event => ($options.onRowEditInit($event))),
          onRowEditSave: _cache[40] || (_cache[40] = $event => ($options.onRowEditSave($event))),
          onRowEditCancel: _cache[41] || (_cache[41] = $event => ($options.onRowEditCancel($event)))
    ...
    ($options.paginatorBottom)
      ? (vue.openBlock(), vue.createBlock(_component_DTPaginator, {
          ...
          onPage: _cache[42] || (_cache[42] = $event => ($options.onPage($event))),
          alwaysShow: $props.alwaysShowPaginator
        }, vue.createSlots({ _: 2 }, [
          (_ctx.$slots.paginatorLeft)
            ? {
    ...
    (_ctx.$slots.footer)
      ...
      : vue.createCommentVNode("", true),
    vue.createVNode("div", _hoisted_5$1, null, 512),
    ($props.reorderableColumns)
      ? (vue.openBlock(), vue.createBlock("span", _hoisted_6$1, null, 512))
      : vue.createCommentVNode("", true),
    ($props.reorderableColumns)
      ? (vue.openBlock(), vue.createBlock("span", _hoisted_7$1, null, 512))
      : vue.createCommentVNode("", true)
  ], 2))
}

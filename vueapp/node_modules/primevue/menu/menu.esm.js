...
import { resolveComponent, resolveDirective, openBlock, createBlock, withCtx, withDirectives, createVNode, toDisplayString, createCommentVNode, Teleport, Transition, mergeProps, Fragment, renderList } from 'vue';
    ...
    ? (openBlock(), createBlock("li", {
        ...
        ($props.item.to && !$props.item.disabled)
          ? (openBlock(), createBlock(_component_router_link, {
              ...
              default: withCtx(({navigate, href}) => [
                withDirectives(createVNode("a", {
                  ...
                  createVNode("span", _hoisted_1, toDisplayString($props.item.label), 1)
                ], 10, ["href", "onClick"]), [
                  [_directive_ripple]
                ])
              ]),
          ...
          : withDirectives((openBlock(), createBlock("a", {
              ...
              createVNode("span", _hoisted_2, toDisplayString($props.item.label), 1)
                  ...
                  return (openBlock(), createBlock(Fragment, {
                    ...
                    (item.items && $options.visible(item) && !item.separator)
                      ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                          (item.items)
                            ? (openBlock(), createBlock("li", _hoisted_2$1, toDisplayString(item.label), 1))
                            : createCommentVNode("", true),

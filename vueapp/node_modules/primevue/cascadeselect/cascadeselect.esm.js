...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_cascadeselect_sub = resolveComponent("cascadeselect-sub");
    ...
    (openBlock(true), createBlock(Fragment, null, renderList($props.options, (option, i) => {
      return (openBlock(), createBlock("li", {
        ...
        ($options.isOptionGroup(option) && $options.isOptionActive(option))
          ? (openBlock(), createBlock(_component_cascadeselect_sub, {
              key: 0,
...
const _hoisted_2$1 = /*#__PURE__*/createVNode("span", { class: "p-cascadeselect-trigger-icon pi pi-chevron-down" }, null, -1);

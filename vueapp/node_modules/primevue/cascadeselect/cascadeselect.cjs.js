...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_cascadeselect_sub = vue.resolveComponent("cascadeselect-sub");
      ...
      return (vue.openBlock(), vue.createBlock("li", {
        ...
        vue.withDirectives(vue.createVNode("div", {
          ...
          ($props.templates['option'])
            ...
            : (vue.openBlock(), vue.createBlock("span", _hoisted_2, vue.toDisplayString($options.getOptionLabelToRender(option)), 1)),
        ...
        ($options.isOptionGroup(option) && $options.isOptionActive(option))
          ? (vue.openBlock(), vue.createBlock(_component_cascadeselect_sub, {
              key: 0,
...
const _hoisted_2$1 = /*#__PURE__*/vue.createVNode("span", { class: "p-cascadeselect-trigger-icon pi pi-chevron-down" }, null, -1);
const _hoisted_3$1 = { class: "p-cascadeselect-items-wrapper" };

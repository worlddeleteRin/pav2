...
var script = {
    ...
    methods: {
        ...
        onClick(event) {
            if (!this.disabled && (!this.overlay || !this.overlay.contains(event.target)) && !utils.DomHandler.hasClass(event.target, 'p-multiselect-close')) {
...
const _hoisted_4 = /*#__PURE__*/vue.createVNode("div", { class: "p-multiselect-trigger" }, [
  /*#__PURE__*/vue.createVNode("span", { class: "p-multiselect-trigger-icon pi pi-chevron-down" })
], -1);

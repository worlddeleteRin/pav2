...
this.primevue.tree = (function (utils, Ripple, vue) {
    ...
    const _hoisted_2 = { class: "p-treenode-label" };
    const _hoisted_3 = {
      key: 0,
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_sub_treenode = vue.resolveComponent("sub-treenode");
      ...
      return (vue.openBlock(), vue.createBlock("li", { class: $options.containerClass }, [
        ...
        ($options.hasChildren && $options.expanded)
          ? (vue.openBlock(), vue.createBlock("ul", _hoisted_3, [
              (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($props.node.children, (childNode) => {
                return (vue.openBlock(), vue.createBlock(_component_sub_treenode, {
                  key: childNode.key,
                  node: childNode,
    ...
    const _hoisted_3$1 = /*#__PURE__*/vue.createVNode("span", { class: "p-tree-filter-icon pi pi-search" }, null, -1);
    const _hoisted_4 = {
